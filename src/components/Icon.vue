...
/**
 * 图标组件：集中管理项目内联 SVG
 * 所有图标基于 24x24 viewBox，stroke 风格统一
 */
defineProps({
...
const paths = {
  ...
  sortDesc: '<line x1="12" y1="5" x2="12" y2="19"/><polyline points="19 12 12 19 5 12"/>',
  sortAsc: '<line x1="12" y1="19" x2="12" y2="5"/><polyline points="5 12 12 5 19 12"/>',
